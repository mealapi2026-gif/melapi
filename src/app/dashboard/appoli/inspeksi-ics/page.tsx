...
export default function InspeksiIcsPage() {
  ...
  const saveData = async () => {
    ...
    try {
      ...
      setMessage('Hasil inspeksi tersimpan di Firestore dan siap dicetak.'); setShowPreview(true);
